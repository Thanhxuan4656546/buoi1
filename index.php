...
if (isset($_POST['submit'])) {
    // Retrieve the filename from the form input
    $filename = $_POST['filename'];

    // Define the file path (optional, you can add a directory like 'uploads/')
    $filepath = $filename . ".txt";

    // Sample content to write in the file
    ...
    // 'w' mode will overwrite if the file exists, and create if it doesn't
    if ($file = fopen($filepath, "w")) {
        ...
        echo "<div class='alert alert-success'>File '$filename' has been successfully written/overwritten!</div>";
    } else {
        // Error handling
        echo "<div class='alert alert-danger'>There was an error writing the file.</div>";
    }
}
?>
        <hr>
